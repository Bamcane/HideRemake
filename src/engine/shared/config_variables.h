...
MACRO_CONFIG_INT(SvDDRaceTuneReset, sv_ddrace_tune_reset, 0, 0, 1, CFGFLAG_SERVER, "Whether DDRace tuning (sv_hit, sv_endless_drag and sv_old_laser) is reset after each map change or not")
